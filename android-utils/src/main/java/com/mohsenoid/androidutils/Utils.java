package com.mohsenoid.androidutils;
...
public class Utils {
    ...
    public static AlertDialog showNoInternetConnectionDialog(
        ...
        builder.setMessage(R.string.androidutils__no_connection);
        builder.setTitle(R.string.androidutils__no_connection_title);
        builder.setPositiveButton(R.string.androidutils__settings,
        ...
        if (isConnectionCritical)
            builder.setNegativeButton(R.string.androidutils__exit,
                    new DialogInterface.OnClickListener() {
            ...
            builder.setNegativeButton(R.string.androidutils__abort, null);
    ...
    public static AlertDialog showNoInternetConnectionDialogOfflineMsg(
        ...
        if (isConnectionCritical)
            ...
            builder.setNegativeButton(R.string.androidutils__offline, null);
    ...
    public static AlertDialog showServerNotAvailableDialog(
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setCancelable(true);
        builder.setMessage(R.string.androidutils__no_server);
        builder.setTitle(R.string.androidutils__no_server_title);
